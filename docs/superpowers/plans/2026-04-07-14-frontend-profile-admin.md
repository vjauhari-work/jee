# Frontend Profile & Admin Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Implement Edit Profile page (update email/phone, change password) and Admin Panel page (question CRUD form, bulk import).

**Architecture:** Edit Profile fetches current user data and shows a form with immutable username/name and editable email/phone. Password change is a separate section. Admin Panel has a form for single question add/edit and a file upload for bulk JSON import.

**Tech Stack:** React 19, TypeScript, axios

---

### Task 1: Edit Profile Page

**Files:**
- Modify: `frontend/src/pages/EditProfile.tsx`

- [ ] **Step 1: Implement Edit Profile page**

Replace `frontend/src/pages/EditProfile.tsx` with:
...
```bash
git add frontend/src/pages/EditProfile.tsx
git commit -m "feat: implement Edit Profile page with email/phone update and password change"
```

---

### Task 2: Admin Panel Page

**Files:**
- Modify: `frontend/src/pages/AdminPanel.tsx`

- [ ] **Step 1: Implement Admin Panel page**

Replace `frontend/src/pages/AdminPanel.tsx` with:
...
git commit -m "feat: implement Admin Panel with question form, bulk import, and answer management"
```

- [ ] **Step 3: Verify entire frontend compiles**
